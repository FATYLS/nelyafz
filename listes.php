...
<?php 
              ...
              {
 print '<div class="alert alert-success"> Stock modifiee avec succes</div>';
              }
              ?>
...
<input type="text" name="quantite" class="form-control" value="<?php echo $stock['quantite'];?>" placeholder="stock du produit...">
          </div>
